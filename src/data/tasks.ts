...
export const INITIAL_TASKS: Task[] = [
    ...
    { id: 't3', title: 'Complete Sections A & C of Application', assignee: 'Fu', internalDeadline: '3/8', status: 'Pending', category: 'Application Prep' },
    ...
    { id: 't5', title: 'Upload/Share Notarized Reference', assignee: 'Jane/Phil', internalDeadline: '3/15', status: 'Pending', category: 'Application Prep' },
    { id: 't6', title: 'Download/Print Final Packet', assignee: 'Fu', internalDeadline: '3/15', status: 'Pending', category: 'Application Prep' },
    { id: 't7', title: 'Mail/Deliver Application to County Clerk', assignee: 'Fu', internalDeadline: '3/16', statutoryDeadline: '3/26', status: 'Pending', category: 'Application Prep' },
